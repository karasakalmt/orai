...
export class RelayerService {
  ...
  private async handleNewQuestion(data: {
    ...
    }, '📥 New question received - starting processing');
    ...
    try {
      ...
      logger.info({
        ...
        storageHash: storageResult.storageHash
      }, '✅ Answer submitted to blockchain successfully');
      ...
      }, '🎉 Question-Answer cycle completed successfully');
